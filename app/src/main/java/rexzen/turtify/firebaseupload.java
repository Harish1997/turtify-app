...
/**
 * Created by harishananth on 25/02/17.
 */
...
public class firebaseupload extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firebaseupload);
       // FirebaseApp.initializeApp(firebaseupload.this);
        ...
        mAuth.signInAnonymously()
                .addOnSuccessListener(this, new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        Intent intent=new Intent(firebaseupload.this,mainact.class);
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (mDownloadUrl != null) {
            downurl=mDownloadUrl.toString();
            //mDownloadUrl has the download url
